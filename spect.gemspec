...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.markdown", "Rakefile", "lib/spect.rb", "lib/spect/expectations.rb", "lib/spect/expecting.rb", "spect.gemspec", "tasks/ann.rake", "tasks/bones.rake", "tasks/gem.rake", "tasks/manifest.rake", "tasks/notes.rake", "tasks/post_load.rake", "tasks/rdoc.rake", "tasks/rubyforge.rake", "tasks/setup.rb", "tasks/test.rake", "test/test_spect.rb"]
  s.has_rdoc = true
